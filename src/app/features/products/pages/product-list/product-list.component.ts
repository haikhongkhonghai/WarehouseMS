...
@Component({
    ...
    standalone: true,
    imports: [RouterLink, FormsModule, CurrencyPipe, PageHeaderComponent, EmptyStateComponent, ConfirmDialogComponent],
...
export class ProductListComponent implements OnInit {
    ...
    protected readonly sortField = signal<'tenSanPham' | 'soLuongTon'>('tenSanPham');
    ...
    protected readonly filteredProducts = computed(() => {
        ...
        result = this.productService.sort(this.sortField(), this.sortDirection(), result);
        return result;
    });
